# Commonspace Storybook agent contract

When implementing or reviewing Commonspace UI:

1. Use the Commonspace catalog MCP or CLI to select exact components, patterns, and tokens before writing code.
