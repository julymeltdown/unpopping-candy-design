export default {
  ...
  entrypoints: ["@unpopping-candy/ui", "@unpopping-candy/ui/avatar"],
  keywords: ["avatar", "identity", "profile", "image", "initials"],
  useWhen: [
  ...
  tokens: ["--popcandy-surface-muted", "--popcandy-border", "--popcandy-ink"],
  related: ["social.user-cell"],
  stories: ["catalog-ui-avatar--contract"],
  accessibility: {
    requirements: [
