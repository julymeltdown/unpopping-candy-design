export default {
  ...
  keywords: ["surface", "panel", "card", "background"],
  useWhen: ["A local region needs contrast, padding, or elevation."],
  avoidWhen: [
  ...
  related: ["ui.container", "ui.separator"],
  stories: ["catalog-ui-surface--contract"],
  accessibility: {
    requirements: [
  ...
  variants: [
    {
      name: "plain",
      guidance:
        "Use the plain variant only when its semantic role matches the surrounding decision or content hierarchy.",
    },
    {
      name: "subtle",
      guidance:
        "Use the subtle variant only when its semantic role matches the surrounding decision or content hierarchy.",
    },
    {
      name: "raised",
      guidance:
        "Use the raised variant only when its semantic role matches the surrounding decision or content hierarchy.",
    },
  ],
