export default {
  ...
  "entrypoints": ["@unpopping-candy/ui", "@unpopping-candy/ui/feedback"],
  ...
  "tokens": ["--popcandy-surface", "--popcandy-shadow-dialog", "--popcandy-positive", "--popcandy-warning", "--popcandy-critical"],
