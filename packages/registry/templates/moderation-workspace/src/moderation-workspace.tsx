...
import { Alert, Button, Container, Inline, Stack, Surface, Tabs } from '@commonspace/ui';
...
export function ModerationWorkspace() {
  ...
  return (
    <Container size="full" className="cs-moderation-workspace">
      <aside aria-label="Moderation queue" className="cs-moderation-workspace__queue">
      ...
      <main className="cs-moderation-workspace__evidence" aria-labelledby="case-title">
        <Stack gap={4}>
      ...
      <aside aria-label="Decision controls" className="cs-moderation-workspace__decision">
        <Stack gap={4}>
