export default {
  ...
  keywords: ["post", "author", "identity", "timestamp"],
  useWhen: [
  ...
  variants: [
    ...
    },
    {
      name: "repost-context",
      guidance:
        "Use the repost-context variant only when its semantic role matches the surrounding decision or content hierarchy.",
    },
  ],
  states: ["default", "verified"],
  examples: {
    preferred: [
      {
        title: "Post identity",
